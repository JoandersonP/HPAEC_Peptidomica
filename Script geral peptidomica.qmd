...
# Carregando os dados a partir do arquivo de texto 1
dados_1 <- read.table("C:/Users/joand/Documents/PEPTIDOMA/peptidoma_OBV_1.txt", header = TRUE, sep = "\t", quote = "")
# Carregando os dados a partir do arquivo de texto 2
dados_2 <- read.table("C:/Users/joand/Documents/PEPTIDOMA/peptidoma_OBV_2.txt", header = TRUE, sep = "\t", quote = "")
...
grafico_1 <- ggplot(dados_top_1, aes(x = n_peptides, y = `Proteina`)) +
  ...
  labs(x = "Número de Peptídeos", y = "Proteína", title = "Top 15 Proteínas (Velos 1)") +
...
grafico_2 <- ggplot(dados_top_2, aes(x = n_peptides, y = `Proteina`)) +
  ...
  labs(x = "Número de Peptídeos", y = "Proteína", title = "Top 15 Proteínas (Velos 2)") +
  theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
        axis.title = element_text(size = 12, face = "bold", family = "Arial"),
        axis.text.x = element_text(size = 10, color = "black", angle = 90, vjust = 0.5, hjust = 1, family = "Arial"),
        axis.text.y = element_text(size = 10, color = "black", face = "bold", family = "Arial"),
...
# Carregando os dados a partir do arquivo de texto 1
dados_1 <- read.table("C:/Users/joand/Documents/PEPTIDOMA/peptidoma_OBE_1.txt", header = TRUE, sep = "\t", quote = "")
# Carregando os dados a partir do arquivo de texto 2
dados_2 <- read.table("C:/Users/joand/Documents/PEPTIDOMA/peptidoma_OBE_2.txt", header = TRUE, sep = "\t", quote = "")
# Selecionando as 10 proteínas com maiores quantidades de peptídeos e reordenando a ordem das barras
dados_top_1 <- dados_1 %>% 
...
grafico_1 <- ggplot(dados_top_1, aes(x = n_peptides, y = `Protein.Description`)) +
  ...
  labs(x = "Número de Peptídeos", y = "Proteína", title = "Top 15 Proteínas (Exploris 1)") +
  theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
        axis.title = element_text(size = 12, face = "bold", family = "Arial"),
        axis.text.x = element_text(size = 10, color = "black", angle = 90, vjust = 0.5, hjust = 1, family = "Arial"),
        axis.text.y = element_text(size = 10, color = "black", face = "bold", family = "Arial"),
...
grafico_2 <- ggplot(dados_top_2, aes(x = n_peptides, y = `Protein.Description`)) +
  ...
  labs(x = "Número de Peptídeos", y = "Proteína", title = "Top 15 Proteínas (Exploris 2)") +
  theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
        axis.title = element_text(size = 12, face = "bold", family = "Arial"),
        axis.text.x = element_text(size = 10, color = "black", angle = 90, vjust = 0.5, hjust = 1, family = "Arial"),
        axis.text.y = element_text(size = 10, color = "black", face = "bold", family = "Arial"),
...
library(tidyverse)
library(data.table)
# Importando os dados do arquivo txt (matriz de ocorrência)
dados_OBE1 <- read.table("C:/Users/joand/Documents/Matriz_Exploris_Tratado1.txt", header=TRUE)
...
# Importando os dados do arquivo txt (matriz de ocorrência)
dados_OBE2 <- read.table("C:/Users/joand/Documents/Matriz_Exploris_Tratado2.txt", header=TRUE)
